...
#validity indexes
pcpi_1=validations.CPI(d,belong)
pintra_1=validations.Intra(original,c,cluster0,cluster1)
pinter_1=validations.Inter(original,c,cluster0,cluster1)
psi_1 = validations.Silhouette(c0array,c1array,cluster0,cluster1)
pmse_1=validations.MSE(c,belong)
pdi_1= validations.DunnIndex(c0array,c1array,centroids,cluster0,cluster1)
