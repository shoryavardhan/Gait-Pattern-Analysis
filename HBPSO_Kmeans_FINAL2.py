...
#validity indexes
hcpi_2=validations.CPI(d,belong)
hintra_2=validations.Intra(original2,c,cluster0,cluster1)
hinter_2=validations.Inter(original2,c,cluster0,cluster1)
hsi_2 = validations.Silhouette(c0array,c1array,cluster0,cluster1)
hmse_2=validations.MSE(c,belong)
hdi_2= validations.DunnIndex(c0array,c1array,centroids,cluster0,cluster1)
