...
#validity indexes
pcpi_3=validations.CPI(d,belong)
pintra_3=validations.Intra(original3,c,cluster0,cluster1)
pinter_3=validations.Inter(original3,c,cluster0,cluster1)
psi_3 = validations.Silhouette(c0array,c1array,cluster0,cluster1)
pmse_3=validations.MSE(c,belong)
pdi_3= validations.DunnIndex(c0array,c1array,centroids,cluster0,cluster1)
