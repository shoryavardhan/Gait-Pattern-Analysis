...
original3_68=dataset.iloc[0:68,[7,8]].values 
original3_88=dataset.iloc[0:88,[7,8]].values 
...
n_particles = 50
#random            
f3c = open('dataset/case3_cp88.csv')
f3i = open('dataset/case3_intact68.csv')
...
class Space():
    ...
    def move_particles(self):
        for particle in self.particles:
            global W
            new_velocity = (W*particle.velocity) + (c1*random.random())*validations.hammingdistance1(particle.pbest_position[0],particle.pbest_position[1],particle.position[0],particle.position[1]) + \
                            (random.random()*c2) * validations.hammingdistance1(self.gbest_position[0],self.gbest_position[1],particle.position[0],particle.position[1])
...
part = Particle()
part.position=np.array([3.1471719, 4.078748,5.671560,4.7315457])
...
#validity indexes
hcpi_3=validations.CPI(d,belong)
hintra_3=validations.Intra(original3,c,cluster0,cluster1)
hinter_3=validations.Inter(original3,c,cluster0,cluster1)
hsi_3 = validations.Silhouette(c0array,c1array,cluster0,cluster1)
hmse_3=validations.MSE(c,belong)
hdi_3= validations.DunnIndex(c0array,c1array,centroids,cluster0,cluster1)
